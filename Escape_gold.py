...
class ShopRoom:
    ...
    def __init__(self):
        ...
        self.shop_goods: dict[int:int] = {ShopRoom.MEDICINE_RECOVER_HP : 5, ShopRoom.MEDICINE_RECOVER_STAMINA : 5, ShopRoom.YELLOW_WEAPON : 4, ShopRoom.PINK_WEAPON : 6}   # {ショップの商品 : 価格}
        self.shop_goods_name: dict[int:str] = {ShopRoom.MEDICINE_RECOVER_HP : "HP回復薬", ShopRoom.MEDICINE_RECOVER_STAMINA : "スタミナ回復薬", ShopRoom.YELLOW_WEAPON : "黄色武器", ShopRoom.PINK_WEAPON : "ピンク色武器"}   # {ショップの商品 : 商品名}
    ...
    def process(self, player: Player) -> None:
        ...
        while (True):
            ...
            if (len(user_select) != 0):   # 入力されている場合.
                ...
                elif (user_select == str(ShopRoom.MEDICINE_RECOVER_HP)):
                    goods_price = self.shop_goods[ShopRoom.MEDICINE_RECOVER_HP]
                    goods_name = self.shop_goods_name[ShopRoom.MEDICINE_RECOVER_HP]
                ...
                elif (user_select == str(ShopRoom.MEDICINE_RECOVER_STAMINA)):
                    goods_price = self.shop_goods[ShopRoom.MEDICINE_RECOVER_STAMINA]
                    goods_name = self.shop_goods_name[ShopRoom.MEDICINE_RECOVER_STAMINA]
                ...
                elif (user_select == str(ShopRoom.YELLOW_WEAPON)):
                    goods_price = self.shop_goods[ShopRoom.YELLOW_WEAPON]
                    goods_name = self.shop_goods_name[ShopRoom.YELLOW_WEAPON]
                ...
                elif (user_select == str(ShopRoom.PINK_WEAPON)):
                    goods_price = self.shop_goods[ShopRoom.PINK_WEAPON]
                    goods_name = self.shop_goods_name[ShopRoom.PINK_WEAPON]
...
def main():
    ...
    player = Player()
    dungeon = Dungeon(dungeon_info, player)
    ...
    while True:
        if (player.stamina > 0):
            ...
            if (player.win_check == True):
                ...
                player.calculate_score()
                input_key = dungeon.restart_select()   # やり直しキーの受付. この中でゲーム終了まで行う
                if (input_key):
            ...
            player.calculate_score()
            input_key = dungeon.restart_select()
